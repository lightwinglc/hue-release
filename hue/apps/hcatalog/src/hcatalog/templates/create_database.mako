...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            ...
            <form action="${ url(app_name + ':create_database')}" method="POST" id="mainForm"
                  class="form-horizontal"> ${ csrf_token_field | n }
                <div class="steps">
                    <div id="step1" class="stepDetails">
                        <fieldset>
                            <div class="alert alert-info">
                                <h3>${_('Create a database')}</h3>${_("Let's start with a name and description for where we'll store your data.")}
                            </div>
                            <div class="control-group">
                                ${comps.bootstrapLabel(database_form["db_name"])}
                                <div class="controls">
                                    ${comps.field(database_form["db_name"], attrs=dict(
                ...
                <div class="form-actions">
                    ...
                    <input id="submit" type="submit" name="create" class="btn btn-primary hide"
                           value="${_('Create database')}"/>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function () {
        ...
        function validate() {
            switch (step) {
                case 1:
                    var databaseNameFld = $("input[name='db_name']");
